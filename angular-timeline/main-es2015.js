...
let TimelineContentComponent = class TimelineContentComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let TimelineEntryComponent = class TimelineEntryComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let TimelineHeaderComponent = class TimelineHeaderComponent {
    constructor() { }
    ngOnInit() {
    }
};
